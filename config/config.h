...
namespace common {
    ...
    public:
        ...
        [[nodiscard]] std::string get_value(const std::string& key, const std::string& section = "") const;
        [[nodiscard]] bool get_bool_value(const std::string& key, bool default_value = false, const std::string& section = "") const;
        [[nodiscard]] int get_int_value(const std::string& key, int default_value = 0, const std::string& section = "") const;
        [[nodiscard]] float get_float_value(const std::string& key, float default_value = 0.0f, const std::string& section = "") const;
